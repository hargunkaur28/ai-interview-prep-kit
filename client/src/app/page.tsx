...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      {/* Top minimal header */}
      <header className="border-b border-[#212330] px-6 py-4 flex items-center justify-between max-w-7xl mx-auto w-full">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 py-12 md:py-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-indigo-500/20 bg-indigo-500/10 text-indigo-400 text-xs font-mono">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white leading-tight">
              Prepare smarter.<br />
              <span className="text-slate-400">Understand the role.</span><br />
              Know the company.
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-[#1C1E2A]">
        ...
        <div className="lg:col-span-5">
          <div className="bg-[#10121A] border border-[#212330] rounded-xl p-8 shadow-2xl shadow-black/50">
            <div className="mb-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0A0B10] border border-[#262838] focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-md py-2 pl-9 pr-3 text-sm text-slate-100 placeholder:text-slate-600 outline-none transition-colors"
                  />
                </div>
              </div>
            ...
            <div className="mt-6 pt-5 border-t border-[#1C1E2A] text-center">
              <button
                type="button"
                onClick={() => {
                  setIsLogin(!isLogin);
      ...
      {/* Minimal Footer */}
      <footer className="border-t border-[#1C1E2A] py-6 text-center text-xs text-slate-500">
